"""interior_engine models — the discovery/trending engine cluster.
Moved out of app_ib/engine_models.py (TASK 13). Tables keep their pinned
app_ib_* db_table names — state-only move, no data touched."""
...
class Architect(models.Model):
    ...
    businesses = models.ManyToManyField("interior_business.Business", blank=True, related_name="linked_architects")
    ...
    expertiseTags = models.ManyToManyField("interior_engine.Tag", blank=True, related_name="expert_architects")
...
class Shop(models.Model):
    ...
    business = models.ForeignKey("interior_business.Business", null=True, blank=True, on_delete=models.SET_NULL, related_name="linked_shops")
    name = models.CharField(max_length=255)
    slug = models.SlugField(max_length=255, unique=True)
    ...
    avgResponseSeconds = models.IntegerField(null=True, blank=True)
    label = models.CharField(max_length=50, blank=True, default="")
    expertiseTags = models.ManyToManyField("interior_engine.Tag", blank=True, related_name="expert_shops")
    timestamp = models.DateTimeField(auto_now_add=True)
    updatedAt = models.DateTimeField(auto_now=True)
...
class ContactInfo(models.Model):
    ...
    business = models.ForeignKey("interior_business.Business", null=True, blank=True, on_delete=models.SET_NULL, related_name="contacts")
...
class Award(models.Model):
    ...
    business = models.ForeignKey("interior_business.Business", null=True, blank=True, on_delete=models.SET_NULL, related_name="awards")
...
class ProcessStep(models.Model):
    ...
    business = models.ForeignKey("interior_business.Business", null=True, blank=True, on_delete=models.SET_NULL, related_name="process_steps")
...
class Review(models.Model):
    ...
    business = models.ForeignKey("interior_business.Business", null=True, blank=True, on_delete=models.SET_NULL, related_name="reviews")
...
class BehindTheTrendStory(models.Model):
    business = models.ForeignKey("interior_business.Business", on_delete=models.CASCADE, related_name="trend_stories")
    rank = models.PositiveIntegerField(default=0)
...
class BusinessTeamMember(models.Model):
    business = models.ForeignKey("interior_business.Business", on_delete=models.CASCADE, related_name="team_members")
...
class BusinessSpecialization(models.Model):
    business = models.OneToOneField(
        "interior_business.Business", on_delete=models.CASCADE, related_name="specialization"
    )
...
class SpecializationJob(models.Model):
    ...
    business = models.ForeignKey(
        "interior_business.Business", on_delete=models.CASCADE, related_name="specialization_jobs"
    )
